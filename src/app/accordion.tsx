...
export const Accordion: React.FC = () => (
  <div className="mx-6 flex flex-col gap-8 rounded-xl bg-white p-6 lg:w-[42rem] lg:p-12">
    <div className="flex items-center gap-4">
      ...
      <h1 className="text-dark-purple text-4xl font-bold lg:text-6xl">FAQs</h1>
    </div>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className="group flex w-full items-center justify-between gap-4">
                <span className="text-dark-purple group-hover:text-purple group-focus:text-purple text-start font-bold transition-colors">
                  {question}
                </span>
